...
# ╔═╡ 7ba64a5f-3eb7-4eb1-bb87-a1a6fd610ec7
begin
    using JSServe
    Page(exportable=true, offline=false)
end

# ╔═╡ c1bd6501-1955-4341-a751-59f5946594b5
begin
	using Unitful, 
		CommonMark, 
		LaTeXStrings, 
...
# ╔═╡ 646b3528-396c-42dc-b30a-0f812c08f7fe
md"""
# ms6.02.056
"""

# ╔═╡ 8c25efc9-fc43-46c8-8b92-7a4b3d6a1dd1
cm"""
Steam ``(\pu{5 lbm})`` contained within a _piston-cylinder assembly undergoes_ an expansion from state ①, where the specific internal   energy is 
``u_1 = \pu{2709.9 Btu/lbm}``, 
to state ②, where 
``u_2 = \pu{2659.6 Btu/lbm}.`` During the process, there is heat transfer to the steam with a magnitude of 
``\pu{80 Btu}``. 
Also, a paddle wheel transfers energy to the steam by work in the amount of 
``\pu{18.5 Btu}``. 
...
![Piston/cylinder with paddlewheel and fire](https://gitlab.com/tupeux/faire-thermodynamique-pluton/-/raw/main/notebooks/assets/ms6,2.56.svg)
...
# ╔═╡ a84ab5de-c73c-45fb-ab5f-57c4e54cf1f0
# ═══ given ════════════════════════════════════
...
# ╔═╡ 4531293e-3a3e-4af7-ba9c-dd279eccda1b
cm"""
## Get organized
...
Q_{in} &-& W_{out} &=& \Delta U_{sys} \\[6pt]
Q_{in} &-& W_{pw,out} - W_{b,out} &=& m \left( u_2 - u_1 \right) \\[6pt]
...
# ╔═╡ 2f79d55a-6af0-4893-970f-c7f17660ed40
cm"
## Attack

Nothing to do, really, but solve:"

# ╔═╡ 66dfce6b-ac3c-443a-8360-09530aa645a3
Wb_out = Qin + Wpw_in - m * (u2 - u1) |> u"btu"

# ╔═╡ 7e1cdfde-d40a-4c3b-8a68-a9010723a81e


# ╔═╡ 9f4b5d00-a24b-4eb5-af3e-356dc0b714a4


# ╔═╡ f40b5128-a666-4930-ab97-4d14e8630bfb
cm"""
> _finis_  
>
> ``W_{b,out} = `` $(round(Wb_out |> typeof, Wb_out, digits=3))
"""

# ╔═╡ 865955b8-cf93-4879-ae5e-ed8ebc2a0d1a


# ╔═╡ 665e8911-5eb5-4109-9fb8-2e500c03c8f1
cm"### Energy balance"

# ╔═╡ 17e66d56-e033-47fc-82c6-11ed71e4dab7
begin
	# Set the default resolution 
	set_theme!(resolution=(1350, 1200));
...
# ╔═╡ afc20b7f-16f4-4d66-bc33-b300575aedc0
# f


# ╔═╡ 08c815c8-ca3b-4015-8d7c-769d5ba9b863


# ╔═╡ 53ff73ed-a90d-4f9c-b6c8-01b561ed4cb3
cm"""
### Appendix
"""

# ╔═╡ ca50581e-8ecd-49b0-a657-ad7a1316221e
HTML("""

<strong> a little styling</strong>

<style>
blockquote {
 color: #008800 !important;
 background-color: transparent  !important;
 border-left: 3px solid #008800 !important;
...
git-tree-sha1 = "d03a98cbf91dfbaab79f39d0a529264ccce253f8"
